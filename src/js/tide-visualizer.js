class EnhancedTideChart {
    ...
    drawChart() {
        ...
        // Generate tide path using API data
        ...
        // Add API-based tide labels
        this.drawAPITideLabels();
    }
    ...
    generateTidePathFromAPIData() {
        ...
        // Convert API tide times to tide points for interpolation
        const tidePoints = [];
        
        // Add previous low (morning)
        ...
        console.log('🌊 Tide points for chart:', tidePoints);
